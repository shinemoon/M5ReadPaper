...
本仓库主许可证为 **Apache License 2.0**，详见 [LICENSE](./LICENSE) 文件。

第三方组件的许可证声明列于 [THIRD-PARTY-NOTICES](./THIRD-PARTY-NOTICES)，各组件的完整许可证文本（待填充）位于 [`licenses/`](./licenses/) 目录。

**发布固件二进制、编译镜像或浏览器扩展包时，须将上述许可证文本一并包含在发布物中。**
