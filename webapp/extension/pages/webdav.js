  ...
  function updateComponentList() {
    ...
    sortedComponents.forEach((comp, idx) => {
      ...
      // 天气组件的配置
        ...
        if (comp.type !== 'daily_poem' && comp.type !== 'one' && comp.type !== 'day' && comp.type !== 'reading_status' && comp.type !== 'huangli') {
        ...
        if (comp.type !== 'dynamic_text' && comp.type !== 'huangli' && comp.type !== 'daily_poem' && comp.type !== 'one' && comp.type !== 'day' && comp.type !== 'reading_status') {
