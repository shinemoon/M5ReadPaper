...
// Canvas管理函数
void bin_font_flush_canvas(bool trans=false, bool invert=false, bool quality=false, display_type effect=NOEFFECT, int x=0, int y=0, int width=0, int height=0);
