...
#define LGFX_PRINTF_ENABLED
  ...
  {
  public:
    enum class epd_wipe_direction_t : int_fast8_t {
      epd_wipe_default = 0,
      epd_wipe_left_to_right = 1,
      epd_wipe_right_to_left = 2,
      epd_wipe_top_to_bottom = 3,
      epd_wipe_bottom_to_top = 4,
      epd_wipe_specialeffect = 5,
    };
...
//----------------------------------------------------------------------------
    ...
    LGFX_INLINE   void setEpdWipeDirection(epd_wipe_direction_t dir, bool oneshot = true) { _panel->setEpdWipeDirection((int_fast8_t)dir, oneshot); }
